...
export const BRICS_FACILITIES: HealthFacility[] = [
  ...
  },
  {
    ...
    doctors_present: 3,
    nurses_present: 6,
    current_stock_pcm500: 2450,
    days_to_stockout: 14.2,
  ...
  },
  {
    ...
    doctors_present: 2,
    nurses_present: 4,
    current_stock_pcm500: 310,
    days_to_stockout: 3.1,
    risk_tier: 'P1_WARNING',
    cascade_risk_score: 0.64
  },
  {
    facility_id: 'PHC-PUN-004',
    name: 'Primary Health Centre Ambegaon',
    country: 'IND',
    district: 'Pune',
    latitude: 19.0142,
    longitude: 73.7845,
    ...
    doctors_present: 2,
    nurses_present: 5,
    current_stock_pcm500: 1820,
    days_to_stockout: 11.5,
    risk_tier: 'P2_SURPLUS',
    cascade_risk_score: 0.18
  },
  {
    facility_id: 'DH-DEPOT-001',
    name: 'Aundh District Central Supply Depot',
    country: 'IND',
    district: 'Pune',
    latitude: 18.5612,
    longitude: 73.8073,
  ...
  {
    facility_id: 'CHC-OR-001',
    name: 'Mthatha Gateway CHC',
    country: 'ZAF',
    district: 'OR Tambo',
    latitude: -31.5892,
    longitude: 28.7844,
  ...
  {
    facility_id: 'UBS-MA-001',
    name: 'UBS Flores Central',
    country: 'BRA',
    district: 'Manaus',
    latitude: -3.1190,
    longitude: -60.0217,
