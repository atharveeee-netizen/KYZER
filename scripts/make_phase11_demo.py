...
# 1. DemoGuideModal.tsx
write('frontend/src/components/tactical/DemoGuideModal.tsx', '''import React, { useState } from 'react';
import { 
  Sparkles, 
  MapPin, 
  TrendingUp, 
...
# 2. Update tactical/index.ts to export DemoGuideModal
...
print('Phase 11 Demo Guide written successfully!')