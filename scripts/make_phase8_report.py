content = '''# 🏛️ PHASE 8 REPORT: SCENARIO LAB & SURGE SIMULATION VERIFIED
...
with open('docs/PHASE_8_REPORT.md', 'w', encoding='utf-8') as f:
    f.write(content)
print('docs/PHASE_8_REPORT.md written successfully!')